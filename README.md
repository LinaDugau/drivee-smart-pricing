# 🚖 Drivee Smart Pricing (Цмна)

Dеб-приложение рекомендует оптимальную цену поездки такси, прогнозируя вероятность принятия водителем и ожидаемый доход.  
На вход — цена пассажира, время, маршрут (A→B) или дистанция; на выход — лучшая цена и альтернативы (90% / 60% / 20% от максимальной вероятности), а также расчёт «своей цены».
...
## 💻 Альтернатива: консольная проверка без Flask
